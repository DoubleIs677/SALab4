...
public class GetSupportCityDatasetResponse  implements java.io.Serializable {
    private tianqi.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult;

    public GetSupportCityDatasetResponse() {
    }

    public GetSupportCityDatasetResponse(
           tianqi.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult) {
     ...
     */
    public tianqi.GetSupportCityDatasetResponseGetSupportCityDatasetResult getGetSupportCityDatasetResult() {
        return getSupportCityDatasetResult;
    }
     ...
     */
    public void setGetSupportCityDatasetResult(tianqi.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult) {
        this.getSupportCityDatasetResult = getSupportCityDatasetResult;
    }
